...
# todo: load the mean vector and covariance matrix for each model

# init coverage table
# todo set these layer indexes to something meaningful please
model1_layer = 3
model2_layer = 3
model3_layer = 3
model_layer_dict1, model_layer_dict2, model_layer_dict3 = init_coverage_tables(model1, model1_layer model2, model2_layer, model3, model3_layer)
...
for _ in range(args.seeds):
    ...
    if not label1 == label2 == label3:
        ...
        # todo update below functions to match the update_coverage function i've created
    ...
    # todo: update this to be next_orthant_to_cover
    ...
    #todo: update this to be a loss function loop, which sums the loss over multiple orthants
    ...
    #todo: some minor changes need to be made here
